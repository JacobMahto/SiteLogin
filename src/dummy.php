...
<div class="col-sm-4 col-12">
<input type="password" name="password" id="confirm_password" placeholder="###########" class="form-control">
</div>
      </div>
      <div class="mt-3 mb-5 row justify-content-center" >
        <input type="submit" class="col-sm-3 col-5 btn btn-primary form-control" >
